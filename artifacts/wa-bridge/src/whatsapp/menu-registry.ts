...
export const MENU_CATALOG: Record<string, MenuEntry> = {
  ...
  stop: { section: '⚔ MODERATION', syntax: 'stop', desc: 'Alias for stopspam', target: 'main', hidden: true },
  ...
  prefix: { section: '⚙ CONFIGURATION', syntax: 'prefix', desc: 'Show the current prefix', target: 'main', hidden: true },
  ...
  getinfo: { section: '⚙ CONFIGURATION', syntax: 'getinfo', desc: 'Alias for userinfo', target: 'main', hidden: true },
  spam: { section: '⚙ CONFIGURATION', syntax: 'spam', desc: 'Alias for sstatus', target: 'main', hidden: true },
  menu: { section: '⚙ CONFIGURATION', syntax: 'menu', desc: 'Show general command menu', target: 'main',
    usage: 'Show the main command menu.',
    permissions: 'Public',
    examples: ['menu'],
    output: 'Premium OS-style menu.', hidden: true },
  help: { section: '⚙ CONFIGURATION', syntax: 'help', desc: 'Alias for menu', target: 'main', hidden: true },
  gmenu: { section: '⚙ CONFIGURATION', syntax: 'gmenu', desc: 'Show group moderation menu', target: 'group', hidden: true },
  ...
  remove: { section: '⚔ MODERATION', syntax: 'remove', desc: 'Alias for kick', target: 'group', hidden: true },
  ...
  welcomemsg: { section: '⚔ MODERATION', syntax: 'welcomemsg [msg]', desc: 'Alias for setwelcome', target: 'group', hidden: true },
  ...
  goodbyemsg: { section: '⚔ MODERATION', syntax: 'goodbyemsg [msg]', desc: 'Alias for setgoodbye', target: 'group', hidden: true },
