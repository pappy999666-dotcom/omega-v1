...
export const MENU_CATALOG: Record<string, MenuEntry> = {
  ...
  public:       { section: '◈ SYSTEM CONFIG',    syntax: 'public [on|off]',           desc: 'Enable/disable public command access',       target: 'main' },
  publicresponse: { section: '◈ SYSTEM CONFIG',  syntax: 'publicresponse [text]',     desc: 'Set the permission denied message',          target: 'main' },
  tagreply:     { section: '◈ SYSTEM CONFIG',    syntax: 'tagreply [on|off]',         desc: 'Enable/disable tagging in bot replies',      target: 'main' },
