...
export const MENU_CATALOG: Record<string, MenuEntry> = {
  ...
  qc: { section: '🎨 STICKER ENGINE', syntax: 'qc [text]', desc: 'Generate a bold text quote sticker', target: 'both',
    usage: 'Render any text as a premium bold sticker. Long text is auto-fitted and wrapped.',
    permissions: 'Owner / Sudo',
    inputs: ['Text'],
    examples: ['qc TAG', 'qc HELLO', 'qc OMEGA'],
  ...
  tg: { section: '🎨 STICKER ENGINE', syntax: 'tg [link] [number]', desc: 'Download a Telegram sticker to WhatsApp', target: 'both',
    usage: 'Resolve a Telegram sticker pack link, then reply with the pack + sticker number to download it as a WhatsApp sticker.',
    permissions: 'Owner / Sudo',
    inputs: ['Telegram Link', 'Sticker Number'],
    examples: ['tg https://t.me/addstickers/StickerPackName', 'tg StickerPackName 3'],
    output: 'Converted WebP sticker sent to the chat.' },
